...
def test_belt_safety_factor_from_splice_strength_and_belt_tension_basic():
    result = _belt_safety_factor_from_splice_strength_and_belt_tension(
...
def test_rating_tension_from_belt_safety_factor_and_belt_tension_basic():
    result = _rating_tension_from_belt_safety_factor_and_belt_tension(
...
def test_belt_safety_factor_from_splice_strength_and_belt_tension_rejects_zero_tension():
