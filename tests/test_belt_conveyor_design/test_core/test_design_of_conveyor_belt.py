...
def test_belt_safety_factor_from_splice_strength_and_belt_tension_basic():
    result = belt_safety_factor_from_splice_strength_and_belt_tension(
...
def test_belt_safety_factor_from_splice_strength_and_belt_tension_unit_conversion():
...
def test_rating_tension_from_belt_safety_factor_and_belt_tension_basic():
    result = rating_tension_from_belt_safety_factor_and_belt_tension(
...
def test_belt_tension_from_splice_strength_and_belt_safety_factor_basic():
    result = belt_tension_from_splice_strength_and_belt_safety_factor(
        splice_strength=2000.0 * u.newton / u.millimeter,
        belt_safety_factor=8.0 * u.dimensionless,
    )
...
def test_safety_factor_inverse_round_trip():
    ...
    safety_factor = belt_safety_factor_from_splice_strength_and_belt_tension(
        splice_strength=splice_strength,
        belt_tension=belt_tension,
    )
    recovered_splice_strength = rating_tension_from_belt_safety_factor_and_belt_tension(
        belt_safety_factor=safety_factor,
        belt_tension=belt_tension,
    )
    recovered_belt_tension = belt_tension_from_splice_strength_and_belt_safety_factor(
        splice_strength=splice_strength,
        belt_safety_factor=safety_factor,
    )
