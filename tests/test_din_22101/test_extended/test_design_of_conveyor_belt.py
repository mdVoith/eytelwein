...
def test_belt_weight_per_square_meter_basic(monkeypatch):
    ...
    monkeypatch.setattr(
        "eytelwein.din_22101.extended.design_of_conveyor_belt._belt_weight_per_square_meter",
...
def test_line_load_belt_basic(monkeypatch):
    # Patch the private implementation to a known calculation for test
    monkeypatch.setattr(
        "eytelwein.din_22101.extended.design_of_conveyor_belt._line_load_belt",
...
def test_line_load_belt_from_belt_weight_per_square_meter_basic(monkeypatch):
    # Patch the private implementation to a known calculation for test
    monkeypatch.setattr(
        "eytelwein.din_22101.extended.design_of_conveyor_belt._line_load_belt_from_belt_weight_per_square_meter",
