...
def convert_surcharge_angles(
    ...
    try:
        ...
        if slope_angle:
            ...
            slope_angle_rad = None
        if surcharge_angle:
            surcharge_angle_rad = surcharge_angle.to(u.radian)
        else:
            surcharge_angle_rad = None
    except Exception as e:
        raise ValueError(f"Error in converting: {e}")
    ...
    angles_rad = _convert_surcharge_angles(
        slope_angle_rad.magnitude if slope_angle_rad else None,
        surcharge_angle_rad.magnitude if surcharge_angle_rad else None,
    )
