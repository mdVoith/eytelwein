...
def load_factor_determining_idler_roll_load_due_to_material(
    ...
    """
    Calculate the load factor determining idler roll load due to material according to VDI 2341.
...
def load_factor_determining_idler_roll_load_due_to_conveyor_belt(
    ...
    """
    Calculate the load factor determining idler roll load due to conveyor belt according to VDI 2341.
    ...
    The load factor formulas according to VDI 2341:
    ...
    - B is the belt width
    - 20 mm is a constant offset according to VDI 2341
    ...
    Examples
    --------
    >>> from eytelwein.vdi_2341.core.idler_rolls import load_factor_determining_idler_roll_load_due_to_conveyor_belt
    >>> from eytelwein.din_22101 import IdlerSets
    >>> from eytelwein.main.units import get_unit_registry
    >>> u = get_unit_registry()
    >>>
