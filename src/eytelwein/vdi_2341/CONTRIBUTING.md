...
# VDI 2341 Library Structure and Design

The VDI 2341 library implements calculations according to the VDI 2341 standard for belt conveyor design. Understanding its structure and design principles is essential for effective contributions.

## Core vs Extended Functionality

The library is organized into two main modules:

### Core Module (`vdi_2341/core/`)

The core part of the library offers all equations and functionality which is directly present in the VDI 2341 standard. It also includes direct derivatives of these functions. For example:
...
- Functions are closely named according to the definitions in the "Symbols and units" section of VDI 2341.
...
### Extended Module (`vdi_2341/extended/`)
...
1. **Private Implementation**: `_module_name.py` contains pure calculation functions with basic types
   ...
   - No unit handling
   - Validation: generally speaking there is no validation. However, if the code explicitly names restrictions on parameters, those validations and limit checks will be implemented in the private functions.
...
- **Unit Conversion**: Functions that convert between units or different standards
  - Example: `convert_surcharge_angles` between VDI 2341 and ISO 5048
...
## Contribution Guidelines for VDI 2341
