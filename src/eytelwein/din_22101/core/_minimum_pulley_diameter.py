...
def _minimum_diameter_of_group_A_B_C_pulleys(
    ...
    Data is loaded from the DIN 22101 standard CSV shipped with the library.
    """
    minimum_diameters: Dict[str, Union[int, None]] = {"A": None, "B": None, "C": None}

    # Use importlib.resources to open the CSV file from the package
    with importlib.resources.open_text(
        "eytelwein.din_22101.data", "minimum_pulley_diameters_DIN_22101.csv"
    ) as file:
        for line in file:
            line = line.strip()
