...
def volume_flow_from_mass_flow_density(
    ...
    >>> from eytelwein.din_22101 import volume_flow_from_mass_flow_density
...
def solve_for_used_belt_width_from_cross_section(
    ...
    troughing_angle: Quantity,
    equivalent_slope_angle: Quantity,
    initial_guess: Optional[Quantity] = None,
    unit: str = "millimeter",
    precision: int = 2,
) -> Quantity:
    """
...
def reduction_factor_inclined_fill(
    ...
    """
    Calculate the reduction factor for inclined fill on a conveyor belt according to DIN 22101.
...
def effective_filling_ratio(
    ...
    """
    Calculate the effective filling ratio of a conveyor belt according to DIN 22101.
