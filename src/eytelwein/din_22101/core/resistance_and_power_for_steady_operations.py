...
from eytelwein.din_22101.core._resistance_and_power_for_steady_operations import (
...
def gradient_resistance(
    ...
    line_load_material: Optional[Quantity] = None,
    unit: str = "newton",
    precision: int = 2,
) -> Quantity:
    """
    ...
    line load of the belt, and line load of the material according to DIN 22101.
...
def gradient_resistance_sections(
    height_differences: Union[Quantity, np.ndarray],
    line_load_belt: Union[Quantity, np.ndarray],
    line_load_material: Optional[Union[Quantity, np.ndarray]] = None,
    unit: str = "newton",
    precision: int = 2,
) -> Quantity:
    """
    ...
    according to DIN 22101, using vectorized calculations.
...
def total_power_at_drive_pulley_due_to_motion_resistances(
    ...
    the given motion resistance and belt speed according to DIN 22101.
...
def friction_resistance_of_skirting_board_from_material_flow(
    ...
    This calculation is based on the friction resistance formula from DIN 22101-3,
    ...
    rankine_coefficient : Quantity
        Rankine coefficient (empirical dimensionless factor from DIN 22101)
    skirting_board_width : Quantity
...
def friction_resistance_per_meter_of_skirting_board_from_material_flow(
    ...
    DIN 22101-3 formula (see `friction_resistance_of_skirting_board_from_material_flow`).
