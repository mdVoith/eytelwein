...
While DIN 22101 presents angles in degrees, internal calculations use radians
for mathematical correctness. Public functions default to returning degrees
to match the standard's presentation format.
"""
